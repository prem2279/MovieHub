...
class MovieDetailsController: UIViewController{
    ...
    let popularityLabel = UIElements.label(text: "Popularity:",textColor: .white, fontSize: 15, fontWeight: .semibold)
    let releaseDateLabel = UIElements.label(text: "2021",textColor: .brown, fontSize: 18, fontWeight: .semibold)
    let languageLabel = UIElements.label(text: "Language:",textColor: .white, fontSize: 15, fontWeight: .semibold)
    let adultLabel = UIElements.label(text: "Adult Content:",textColor: .white, fontSize: 15, fontWeight: .semibold)
    let votesLabel = UIElements.label(text: "Votes:",textColor: .white, fontSize: 15, fontWeight: .semibold)
    let englishTitleLabel = UIElements.label(text: "English Title:",textColor: .white, fontSize: 15, fontWeight: .semibold)
